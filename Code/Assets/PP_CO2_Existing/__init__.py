...
class PP_CO2_Existing_Asset(Asset_STEVFNs):
    """Class of Conventional Generators"""
    asset_name = "PP_CO2_Existing"
    ...
    def conversion_fun_3(flows, params):
        '''
        Conversion function to limit capacity to existing levels
        '''
        return params["existing_capacity"] - cp.max(flows)
