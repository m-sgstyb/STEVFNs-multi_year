...
class RE_PV_BAU_Asset(Asset_STEVFNs):
    """Class of PV asset limited to growth under BAU or Fossil-centred scenarios"""
    asset_name = "RE_PV_BAU"
    target_node_type = "EL"
    source_node_type_2 = "NULL"
    target_node_type_2 = "RE_PV_BAU"
    period = 1
    transport_time = 0
