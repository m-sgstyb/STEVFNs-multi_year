...
class RE_WIND_MY_Asset(Asset_STEVFNs):
    ...
    def __init__(self):
        ...
        self.conversion_fun_params_2 = {"maximum_size": cp.Parameter(nonneg=True,
                                        ...
                                        "max_global_share": cp.Parameter(nonneg=True,
    ...
    def build_edge(self, edge_number):
        ...
        # Create a list of zero expressions for each year
        self.cumulative_new_installed = [cp.Constant(0) for _ in range(self.num_years)]
    ...
    #     # growth_rate = 0.2 # hard coded, make parameters
